...
if not API_KEY:
    ...
    print("For local testing, add your key below:")
    # API_KEY = 'your-key-here'  # Uncomment and add your key for local testing
...
def ask_gemini(user_message, products):
    ...
    if not API_KEY:
        return "INTENT: CHAT\nPRODUCT_ID: NONE\nRESPONSE: Sorry, the AI service is not configured. Please set the GEMINI_API_KEY environment variable."
...
if __name__ == '__main__':
    ...
    # For production, bind to 0.0.0.0 and disable debug
    # For local development, you can change to debug=True
